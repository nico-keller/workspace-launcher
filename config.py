"""User-specific configuration — plain settings only.

Deliberately has zero imports from `launcher`. If this file ever needs to
import something from the package, that's a sign the import belongs in
main.py instead — see the circular-import note in the README.
"""
